    ...
    <form id="form1" runat="server">
        <div class="auto-style4" id="myDiv">
            ...
            <div id="login" style="padding-left:1em;">
                ...
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="login" runat="server" ControlToValidate="loginUser" ErrorMessage="Tax Number Requiered"></asp:RequiredFieldValidator>
            ...
            <div id="register" hidden="hidden" style="padding-left:1em;">
                ...
                <br /><br/>
                <asp:Label ValidationGroup="register" class="radiobnt" runat="server" Text="Preparing the VAT return form:" Font-Size="Medium" ></asp:Label>
